        ...
        function set.trig(obj, val)
            if val == 'noteOn_'
                ...
                if obj.pastVal(1) ~= obj.strikePos || obj.pastVal(2) ~= obj.strikeVig || obj.pastVal(3) ~= obj.dimension || obj.pastVal(4) ~= obj.material % synth new waveform only if parameters are changed
                    ...
                    obj.decay = obj.decay - (0.99999+(0.0099-0.99999)*obj.material);
                    ...
                    obj.buff(obj.instID,:) = f_bdwg(obj.modes(1:24)*obj.dimension, obj.decay(1:24), length(obj.buff(1,:)), obj.fs, [0.999; 1.001], obj.lpfPole, obj.strikeGain(1:24))'; % banded waveguide
                    % waveguide mesh
