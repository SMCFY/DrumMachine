...
freqs = [200 300 1000 1048 557 664 53 44 27 39 88 97 101]; % fundamental frequency of delay lines (modes) (Hertz)
decay = [0.999 0.998 0.997 0.998 0.998 0.998 0.998 0.998 0.998 0.998 0.998 0.998 0.998]; % decay factors
...
% theta = acos(cosT);
% A0 = (1-R.^2).*sin(theta); % gain (damping factor) (multiplicative loss per oscillation) ???
% 
% % a and b coefficients
% a = zeros(n_modes, 3);
% b = zeros(n_modes, 3);
% for i = 1:n_modes
%     b(i,:) = [1, 0, -1]; % b coeff always the same
